import { Show, children, createSignal, mergeProps } from 'solid-js';
...
interface AlertProps extends Omit<BaseNoChildrenComponentProps, 'onClick'> {
  afterClose?: () => void;
